...
const DemoDataGenerator = {
  getTeachers() {
    return [
      // 行政主管與組長
      { id: 'T_DIR_01', name: '林建志', type: 'INSIDE', title: 'DIRECTOR', basePeriods: 2, reductionReason: '教務主任減課', reductionPeriods: 18, phone: '0910-111-222', salaryPoint: 500, note: '教務主任', tags: ['數學', '行政管理'] },
      { id: 'T_LEA_01', name: '陳美惠', type: 'INSIDE', title: 'LEADER', basePeriods: 8, reductionReason: '教學組長減課', reductionPeriods: 12, phone: '0911-222-333', salaryPoint: 450, note: '教學組長', tags: ['國語', '社會', '課程規劃'] },
      { id: 'T_DIR_02', name: '張敏華', type: 'INSIDE', title: 'DIRECTOR', basePeriods: 2, reductionReason: '學務主任減課', reductionPeriods: 18, phone: '0912-333-444', salaryPoint: 475, note: '學務主任', tags: ['體育', '童軍'] },
      { id: 'T_LEA_02', name: '黃士豪', type: 'INSIDE', title: 'LEADER', basePeriods: 8, reductionReason: '生教組長減課', reductionPeriods: 12, phone: '0913-444-555', salaryPoint: 410, note: '生教組長', tags: ['體育', '品德教育'] },
      { id: 'T_DIR_03', name: '許書瑋', type: 'INSIDE', title: 'DIRECTOR', basePeriods: 2, reductionReason: '總務主任減課', reductionPeriods: 18, phone: '0914-555-666', salaryPoint: 475, note: '總務主任', tags: ['自然', '環境教育'] },
      { id: 'T_DIR_04', name: '廖秀娟', type: 'INSIDE', title: 'DIRECTOR', basePeriods: 2, reductionReason: '輔導主任減課', reductionPeriods: 18, phone: '0915-666-777', salaryPoint: 490, note: '輔導主任', tags: ['綜合活動', '諮商輔導'] },
      { id: 'T_LEA_03', name: '柯孟君', type: 'INSIDE', title: 'LEADER', basePeriods: 8, reductionReason: '輔導組長減課', reductionPeriods: 12, phone: '0916-777-888', salaryPoint: 370, note: '輔導組長', tags: ['綜合活動', '生命教育'] },

      // 導師群 (101~602)
      { id: 'T_HOM_101', name: '王雅婷', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '', reductionPeriods: 0, phone: '0920-101-001', salaryPoint: 330, note: '101導師', tags: ['低年級', '國語', '生活'] },
      { id: 'T_HOM_102', name: '施宜均', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '額滿學校減課', reductionPeriods: 2, phone: '0920-102-002', salaryPoint: 350, note: '102導師 (額滿減課2節)', tags: ['低年級', '生活', '繪本'] },
      { id: 'T_HOM_103', name: '鄭雅文', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '', reductionPeriods: 0, phone: '0920-103-003', salaryPoint: 290, note: '103導師', tags: ['低年級', '生活', '美勞'] },
      { id: 'T_HOM_201', name: '郭佩琪', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '二年級學年主任減課', reductionPeriods: 1, phone: '0920-201-001', salaryPoint: 390, note: '201導師 (學年主任)', tags: ['低年級', '國語', '數學'] },
      { id: 'T_HOM_202', name: '蔡育倫', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '', reductionPeriods: 0, phone: '0920-202-002', salaryPoint: 310, note: '202導師', tags: ['低年級', '資訊融入', '數學'] },
      { id: 'T_HOM_301', name: '吳冠霖', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '', reductionPeriods: 0, phone: '0920-301-001', salaryPoint: 350, note: '301導師', tags: ['中年級', '數學', '社會'] },
      { id: 'T_HOM_302', name: '洪麗珠', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '', reductionPeriods: 0, phone: '0920-302-002', salaryPoint: 430, note: '302導師', tags: ['中年級', '國語', '自然'] },
      { id: 'T_HOM_401', name: '楊斯涵', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '數位學習精進方案減課', reductionPeriods: 1, phone: '0920-401-001', salaryPoint: 370, note: '401導師 (平板推動種子)', tags: ['中年級', '資訊', '數學'] },
      { id: 'T_HOM_402', name: '謝佳芳', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '', reductionPeriods: 0, phone: '0920-402-002', salaryPoint: 330, note: '402導師', tags: ['中年級', '國語', '英語'] },
      { id: 'T_HOM_501', name: '鍾宜真', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '', reductionPeriods: 0, phone: '0920-501-001', salaryPoint: 390, note: '501導師', tags: ['高年級', '社會', '作文'] },
      { id: 'T_HOM_502', name: '簡維廷', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '', reductionPeriods: 0, phone: '0920-502-002', salaryPoint: 290, note: '502導師', tags: ['高年級', '自然', '數學'] },
      { id: 'T_HOM_601', name: '鄧宇廷', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '', reductionPeriods: 0, phone: '0920-601-001', salaryPoint: 410, note: '601導師 (畢業班)', tags: ['高年級', '數學', '體育'] },
      { id: 'T_HOM_602', name: '蘇雅玲', type: 'INSIDE', title: 'HOMEROOM', basePeriods: 16, reductionReason: '', reductionPeriods: 0, phone: '0920-602-002', salaryPoint: 370, note: '602導師 (畢業班)', tags: ['高年級', '國語', '社會'] },

      // 專任科任教師
      { id: 'T_SUB_PE', name: '李家豪', type: 'INSIDE', title: 'SUBJECT', basePeriods: 20, reductionReason: '', reductionPeriods: 0, phone: '0930-111-333', salaryPoint: 350, note: '體育科任 (超鐘點2節/週)', tags: ['體育', '桌球', '田徑'] },
      { id: 'T_SUB_ENG', name: '羅美娟', type: 'INSIDE', title: 'SUBJECT', basePeriods: 20, reductionReason: '', reductionPeriods: 0, phone: '0930-222-444', salaryPoint: 390, note: '英語科任 (超鐘點1節/週)', tags: ['英語', '雙語教學'] },
      { id: 'T_SUB_SCI', name: '劉德華', type: 'INSIDE', title: 'SUBJECT', basePeriods: 20, reductionReason: '', reductionPeriods: 0, phone: '0930-333-555', salaryPoint: 450, note: '自然科任 (每週20節)', tags: ['自然', '科學實驗', '創客'] },
      { id: 'T_SUB_MUS', name: '邱雅惠', type: 'INSIDE', title: 'SUBJECT', basePeriods: 20, reductionReason: '', reductionPeriods: 0, phone: '0930-444-666', salaryPoint: 370, note: '音樂科任 (超鐘點2節/週)', tags: ['音樂', '合唱團', '直笛'] },
      { id: 'T_SUB_ART', name: '曾慶祥', type: 'INSIDE', title: 'SUBJECT', basePeriods: 20, reductionReason: '', reductionPeriods: 0, phone: '0930-555-777', salaryPoint: 330, note: '美勞科任 (每週20節)', tags: ['美勞', '立體造型', '書法'] },
      { id: 'T_SUB_ICT', name: '葉芳儀', type: 'INSIDE', title: 'SUBJECT', basePeriods: 20, reductionReason: '', reductionPeriods: 0, phone: '0930-666-888', salaryPoint: 350, note: '資訊科任 (超鐘點3節/週)', tags: ['資訊', '程式設計', '無人機'] },
      { id: 'T_SUB_SOC', name: '莊宗憲', type: 'INSIDE', title: 'SUBJECT', basePeriods: 20, reductionReason: '', reductionPeriods: 0, phone: '0930-777-999', salaryPoint: 410, note: '社會科任 (每週20節)', tags: ['社會', '鄉土文化'] },
      { id: 'T_SUB_MIN', name: '范姜慧敏', type: 'INSIDE', title: 'SUBJECT', basePeriods: 20, reductionReason: '', reductionPeriods: 0, phone: '0930-888-000', salaryPoint: 430, note: '閩南語專任 (每週20節)', tags: ['閩南語', '鄉土語言', '認證中高級'] },

      // 外聘代課師資庫 (人才庫)
      { id: 'T_EXT_01', name: '高雅涵', type: 'EXTERNAL', title: 'SUBJECT', basePeriods: 0, reductionReason: '', reductionPeriods: 0, phone: '0912-345-678', salaryPoint: 190, note: '配合度極高、週二四全天、具閩南語與國語專長', tags: ['閩南語', '國語', '低年級'] },
      { id: 'T_EXT_02', name: '蕭逸凡', type: 'EXTERNAL', title: 'SUBJECT', basePeriods: 0, reductionReason: '', reductionPeriods: 0, phone: '0928-765-432', salaryPoint: 190, note: '體育系畢業、專長田徑、球類，上午皆可排課', tags: ['體育', '健康', '活動帶領'] },
      { id: 'T_EXT_03', name: '呂建宏', type: 'EXTERNAL', title: 'SUBJECT', basePeriods: 0, reductionReason: '', reductionPeriods: 0, phone: '0955-888-999', salaryPoint: 190, note: '資訊與自然專長、生生用平板授課經驗豐富', tags: ['資訊', '自然', '數學'] },
      { id: 'T_EXT_04', name: '周思潔', type: 'EXTERNAL', title: 'SUBJECT', basePeriods: 0, reductionReason: '', reductionPeriods: 0, phone: '0966-333-777', salaryPoint: 170, note: '英語系碩士、具國小雙語合格教師證', tags: ['英語', '雙語教學', '國際教育'] },
      
      // 退休人才庫
      { id: 'T_RET_01', name: '彭淑芬', type: 'RETIRED', title: 'HOMEROOM', basePeriods: 0, reductionReason: '', reductionPeriods: 0, phone: '0933-111-222', salaryPoint: 625, note: '本校資深優良退休教師、班級經營極佳、隨傳隨到', tags: ['導師', '低年級', '中年級', '國語'] },
      { id: 'T_RET_02', name: '張國榮', type: 'RETIRED', title: 'SUBJECT', basePeriods: 0, reductionReason: '', reductionPeriods: 0, phone: '0933-222-333', salaryPoint: 625, note: '退休自然科教師、課堂秩序掌控良好', tags: ['自然', '數學', '美勞'] }
    ];
  },
